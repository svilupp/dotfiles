...
packer.startup {
  function(use)
    ...
    use {"hrsh7th/cmp-cmdline", after = "nvim-cmp"}
  	use { 'f3fora/cmp-spell',afeter="nvim-cmp" }
    ...
    --   end,
    -- }
    -- JS: Super fast buffer jump
    use {'ggandor/leap.nvim',event = "VimEnter",
      config = [[require('config.nvim_leap')]]
...
--JS load custom functions
-- add my custom function
require 'config.julia-utils'
